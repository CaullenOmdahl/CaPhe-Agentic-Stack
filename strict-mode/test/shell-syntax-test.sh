...
python3 -m py_compile "$ROOT/memory/mempalace_adapter.py" "$ROOT/memory/export_codex_memory.py" "$ROOT/memory/benchmark_memory.py" "$ROOT/memory/sync_mempalace.py"
